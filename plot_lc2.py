...
def plot_lc(plot_name, title, flag, all_features_data, rfe_data):
    ...
    tr_size = list(rmse_df['trainset_size'].unique())
    ...
    X_ = np.array(tr_size, dtype=float)*n_points #change number of data
    X = X_.astype(int)
    ...
    plt.xlabel('Training set size (# of points)',fontsize=12, fontweight='bold')
